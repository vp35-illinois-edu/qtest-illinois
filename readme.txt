...
================================
-run_qtest.sh (shell script for temporarily setting environment variables and executing 
 the application)
   -to run the shell script, type
   
       ./run_qtest.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v96, run the shell script as:
       ...
       ./run_qtest.sh /mathworks/home/application/v96
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_qtest.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure qtest.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r qtest.zip qtest.app
    or the tar command 
    tar -cvf qtest.tar qtest.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v96/runtime/maci64:MR/v96/sys/os/maci64:MR/v96/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_qtest.sh 
